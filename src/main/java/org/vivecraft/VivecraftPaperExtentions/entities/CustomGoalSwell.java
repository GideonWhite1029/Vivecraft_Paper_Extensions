...
public class CustomGoalSwell extends Goal {
	...
	public boolean canUse(){
		...
		if(vse.getConfig().getBoolean("CreeperRadius.enabled") == true){
			if(livingentity != null && VPE.vivePlayers.containsKey(livingentity.getBukkitEntity().getUniqueId()) && VPE.isVive(VPE.vivePlayers.get(livingentity.getBukkitEntity().getUniqueId()).player))
